let baza = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRNSDp3vQM7DCWpew3jVvMjE_fO1MUqTVOYtq_MtgZFtFv379l1eb1A3AyWMMNR_FC4aAL-Ed3blb8n/pub?gid=0&single=true&output=csv";
...
$(document).ready(function () {
    ...
    generateQuestionAndAnswers = function () {
        ...
        $(".definicija").html("<span class='gla'>" + podatci[questionCounter].riječ + "</span> <span class='lat'>(" + podatci[questionCounter].riječ + ")</span>")
        //spajanje krivih i točnih odgovora te generiranje liste pitanja
        lista = podatci[questionCounter].krivo.split(";")
        lista.push(podatci[questionCounter].točno)
        shuffle(lista)
    ...
    getCorrectAnswer = function () {
        correctAnswer = podatci[questionCounter].točno.replace("<br>", "");
    };
...
function odgovor() {
    ...
    if (document.getElementById("pageBeginCountdown").value == "0") {
        ...
        Swal.fire({
            ...
            html: "<p style='text-align:center; font-size: 1.5em;'><strong>Točan je odgovor: <span style='color:#bb422a; ' >" + podatci[questionCounter].točno + "</span></strong></p><br>",
