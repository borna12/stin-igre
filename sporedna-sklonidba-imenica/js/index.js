let baza = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRXtp7kX64hR8NoKSljph3JyWjjSyeo_-qvrCuKwqSUJXx3IfrBOcfAwrehDtS8miEEJB3FvVxJ_FWV/pub?gid=1724662747&single=true&output=csv";
...
$(document).ready(function () {
    ...
    newQuiz = function () {
        ...
        if (set_pitanja2==1){cat2="i-sklonidba";}
        else if (set_pitanja2==2){cat2="n-sklonidba";}
        else if (set_pitanja2==3){cat2="u-sklonidba";}
        else if (set_pitanja2==4){cat2="s-sklonidba";}
        else if (set_pitanja2==5){cat2="t-sklonidba";}
        else if (set_pitanja2==6){cat2="v-sklonidba";}
...
function odgovor() {
    ...
    if (document.getElementById("pageBeginCountdown").value == "0") {
        ...
        Swal.fire({
            ...
            html: "<p style='text-align:center; font-size: 1.5em;'><strong>Točan je odgovor: <span style='color:#bb422a; ' >" + podatci[questionCounter].točanodgovor + "</span>("+podatci[questionCounter].padež+")</strong></p><br><figure><img src='slike/" + podatci[questionCounter].slika + " 'class='slikica2'/> </figure>",
        ...
        if (userSelectedAnswer === correctAnswer) {
            ...
            Swal.fire({
                ...
                html: "<span style='font-size:1.5em'>+" + broj + "</span><br><span style='color:green; ' >" + podatci[questionCounter].točanodgovor + "</span> ("+podatci[questionCounter].padež+")</strong><br><figure><img src='slike/" + podatci[questionCounter].slika + "'class='slikica2'/> </figure></p>",
                showCloseButton: true,
                confirmButtonText: ' dalje',
                backdrop: false,
                allowOutsideClick: false, allowEscapeKey: false
