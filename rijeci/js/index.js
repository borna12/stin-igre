let baza = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSp1NC_5cFXGnvuF4hrSeRAauITDdqObZVqn9gPIARs8ZFTK__ktKel3xt7KXx9Sb-Yf90krg5wKxj0/pub?gid=819035642&single=true&output=csv";
...
$(document).ready(function () {
    ...
    generateQuestionAndAnswers = function () {
        ...
        lista.push(podatci[questionCounter].tocno)
        shuffle(lista)
    ...
    getCorrectAnswer = function () {
        correctAnswer = podatci[questionCounter].tocno.replace("<br>", "");
    };
...
function odgovor() {
    ...
    if (document.getElementById("pageBeginCountdown").value == "0") {
        ...
        Swal.fire({
            ...
            html: "<p style='text-align:center; font-size: 1.5em;'><strong>Točan je odgovor: <span style='color:#bb422a; ' >" + podatci[questionCounter].tocno + "</span></strong></p><br>",
